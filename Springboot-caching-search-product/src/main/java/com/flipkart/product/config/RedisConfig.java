package com.flipkart.product.config;
...
public class RedisConfig {
	...
	public RedisConnectionFactory redisConnectionFactory() {
		...
		RedisStandaloneConfiguration redisConfig = new RedisStandaloneConfiguration("driven-glowworm-27504.upstash.io",
				6379);
		redisConfig.setUsername("default");
		redisConfig.setPassword("AWtwAAIncDFlZTJkMmQxOWMzNDY0MjhiOTEzY2E2MDRkYTBkY2Y5YnAxMjc1MDQ");
